    ...
    <form action="patientRegister" method="post" class="text-info">
        ...
        <div class="card person-card p-2 mb-4 shadow-lg">
            <div class="card-body">
                ...
                <h2 id="who_message" class="card-title text-info">Let us know your name </h2>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-5">
                        <s:textfield id="first_name" type="text" name ="f_name" class="form-control" placeholder="First name"></s:textfield>
                        <div id="first_name_feedback" class="invalid-feedback">
                            
                        </div>
                    </div>
                    <div class="form-group col-md-5">
                        <input id="last_name" type="text" name="l_name" class="form-control" placeholder="Last name">
                ...
                <div class="card shadow-lg">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="email" class="col-form-label">Email : <small class="text-info">This will be used to login to user account</small></label>
                        ...
                        <div class="form-group">
                            <label for="tel" class="col-form-label">NIC</label>
                            <input type="number" class="form-control" id="tel" placeholder="123456789v" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tel" placeholder="011 123 123" required>
                            <div class="phone-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="" cols="" class="form-control" placeholder="221/B Backer's street"></textarea>
        ...
        <div style="margin-top: 1em;" class="mb-5">
            <button type="submit" class="btn btn-info btn-lg btn-block shadow">Sign up !</button>
        </div>
        </form>
</div>
