								...
								<div class="col-sm-12 col-lg-12 ">
									<div class="card p-3">
										<div class="d-flex align-items-center">
											...
											<div>
												<h4 class="m-0">
													<a href="getAdmitDetails" class="btn btn-info"
								...
								<div class="col-sm-12 col-lg-12">
									<div class="card p-3">
										<div class="d-flex align-items-center">
											...
											<div>
												<h4 class="m-0">
													<a href="viewAdmits" class="btn btn-info"
						...
						<div class="container-fluid">
							...
							<div class="card p-3" id="content-form">
								<div class="card-header mb-5">
									<h2 class=" mb-3 text-info">View Admits</h2>
								...
								<table id="tbl" class="table display">
									...
									<tbody>
										<s:iterator value="admitList"> 
											<tr>
												<td><s:property value="ward_no" /></td>
												<td><s:property value="p_id" /></td>
												<td><s:property value="reason" /></td>
												<td><s:property value="admit_date" /></td>
