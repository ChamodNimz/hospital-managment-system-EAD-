<div class="header py-4">
	<div class="container">
		<div class="d-flex">
			<a class="header-brand" href="./index.jsp"> <img
				src="./demo/brand/logo.png" class="header-brand-img"
				alt="tabler logo">
			</a>
			<div class="d-flex order-lg-2 ml-auto">
				...
				<div class="dropdown">
					<a href="#" class="nav-link pr-0 leading-none"
						...
						style="background-image: url(./demo/faces/male/chamod.jpg)"></span>
						<span class="ml-2 d-none d-lg-block"> <span
							class="text-default">Chamod Nimsara</span> <small
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
						...
						</a> <a class="dropdown-item" href="#"> <span class="float-right"><span
								class="badge badge-primary">6</span></span> <i
							class="dropdown-icon fe fe-mail"></i> Inbox
						</a> <a class="dropdown-item" href="#"> <i
