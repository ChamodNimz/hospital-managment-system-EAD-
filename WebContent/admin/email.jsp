...
<title>Email - tabler.github.io - a responsive, flat and full
							...
							<div>
								<div class="list-group list-group-transparent mb-0">
									<a href="#"
										...
										<span class="ml-auto badge badge-primary">14</span>
									</a> <a href="#"
										class="list-group-item list-group-item-action d-flex align-items-center">
										<span class="icon mr-3"><i class="fe fe-send"></i></span>Sent
										Mail
									</a> <a href="#"
										class="list-group-item list-group-item-action d-flex align-items-center">
										<span class="icon mr-3"><i class="fe fe-alert-circle"></i></span>Important
										<span class="ml-auto badge badge-secondary">3</span>
									</a> <a href="#"
										class="list-group-item list-group-item-action d-flex align-items-center">
								...
								<div class="mt-6">
									<a href="#" class="btn btn-secondary btn-block">Compose new
										Email</a>
								</div>
							</div>
						</div>
								...
								<div class="card-body">
									<form action="">
										...
										<div class="btn-list mt-4 text-right">
											...
											<button type="submit" class="btn btn-primary btn-space">Send
												message</button>
										</div>
									</form>
								</div>
