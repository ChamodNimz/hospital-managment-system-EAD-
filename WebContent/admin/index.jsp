						...
						<div class="col-sm-6 col-lg-3">
							<div class="card p-3">
								<div class="d-flex align-items-center">
									...
									<div>
										<h4 class="m-0">
											<a href="javascript:void(0)">132 <small>Transactions</small></a>
										</h4>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="card p-3">
								<div class="d-flex align-items-center">
									...
									<div>
										<h4 class="m-0">
											<a href="javascript:void(0)">78 <small>Inquiries</small></a>
										</h4>
										<small class="text-muted"></small>
									</div>
								</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="card p-3">
								<div class="d-flex align-items-center">
									...
									<div>
										<h4 class="m-0">
											<a href="javascript:void(0)">1,352 <small>Registrations</small></a>
										</h4>
									...
									<div class="col-sm-6 col-lg-6 ">
										<div class="card p-3">
											<div class="d-flex align-items-center">
												...
												<div>
													<h4 class="m-0">
														<a href="tests.jsp">Tests <small></small></a>
													</h4>
									...
									<div class="col-sm-6 col-lg-6">
										<div class="card p-3">
											<div class="d-flex align-items-center">
												...
												<div>
													<h4 class="m-0">
														<a href="doctor-index.jsp">Doctors <small></small></a>
													</h4>
													<small class="text-muted"></small>
												</div>
											</div>
		...
		<div class="footer">
			<div class="container">
				<button type="button" class="btn btn-primary mb-3"
					...
					<i class="si si-printer"></i> Print Dashboard
				</button>
				<div class="row">
					<div class="col-lg-8">
						<div class="row">
